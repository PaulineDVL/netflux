...
var PlayerHandler = function(castPlayer) {
    ...
    this.load = function(mediaIndex) {
        ...
        document.getElementById('media_director').innerHTML =
            castPlayer.mediaContents[castPlayer.currentMediaIndex]['director'];
        document.getElementById('media_date').innerHTML =
            castPlayer.mediaContents[castPlayer.currentMediaIndex]['date'];
...
CastPlayer.prototype.initializeUI = function() {
    ...
    document.getElementById('media_director').innerHTML =
        this.mediaContents[this.currentMediaIndex]['director'];
    document.getElementById('media_date').innerHTML =
        this.mediaContents[this.currentMediaIndex]['date'];
...
'videos' : [
    { 'description' : "Alors que la guerre fait rage, Pierre Bezukhov, devenu comte, épouse Helene Kuragina. Nikolai et André Bolkonsky se préparent à une nouvelle bataille, après avoir réussi à ralentir les Français. Le prince Vassily Kuragin, quant à lui, pousse la princesse Marya à se rapprocher de son fils Anatole...",
        'sources' : ['/film/War.And.Peace.2016.S01E02.FRENCH.720p.HDTV.x264-SH0W.WwW.Zone-Telechargement.Ws.mkv'],
        'subtitle' : 'Drame, Histoire, Romance ',
        'thumb' : '/war-and-peace-2.jpg',
        'title' : 'War and Peace - Saison 1 Episode 2',
        'director': 'Tom Harper',
        'date': '2016'
    },
    { 'description' : 'Pierre doit dissimuler sa nervosité lorsqu\'il rencontre Dolokhov. A l\'issue de cette entrevue, son destin va prendre une nouvelle direction. De leur côté, Nathasha et Sonya Rostova reçoivent des propositions auxquelles elles ne s\'attendaient pas. André, quant à lui, tente d\'étouffer son chagrin...',
        'sources' : ['./film/War.And.Peace.2016.S01E03.FRENCH.720p.HDTV.x264-SH0W.WwW.Zone-Telechargement.Ws.mkv'],
        'subtitle' : 'Drame, Histoire, Romance',
        'thumb' : '/war-and-peace-2.jpg',
        'title' : 'War and Peace - Saison 1 Episode 3',
        'director': 'Tom Harper',
        'date': '2016'
    ...
    { 'description' : 'Le lion Mufasa, roi des animaux, et son épouse Sarabi donnent naissance à Simba, un futur héritier. Mais Scar, le frère de Mufasa, voyant diminuer ses chances d\'accéder au trône, incite le lionceau à s\'aventurer dans un cimetière des éléphants situé au-delà des frontières du royaume...',
        'sources' : ['./film/le-roi-lion.mp4'],
        'subtitle' : 'Familial, Animation, Drame',
        'thumb' : '/The-Lion-King-Poster-1994-MyPosterCollection.com-6.jpg',
        'title' : 'Le roi lion',
        'director': 'Rob Minkoff',
        'date': '1994'

    },
    { 'description' : "Thor est emprisonné de l’autre côté de l’univers sans son puissant marteau et se retrouve engagé dans une course contre le temps pour rejoindre Asgard et arrêter Ragnarok – la destruction de son monde natal et la fin de la civilisation Asgardienne – des mains d’une toute nouvelle menace, l’impitoyable Hela. Mais d’abord, il doit survivre à une compétition meurtrière de gladiateurs qui l’oppose à son ancien allié et compagnon Avenger – l’Incroyable Hulk !",
        'sources' : ['./film/thor-ragnarok.mp4'],
        'subtitle' : 'Action, Aventure, Comédie, Fantastique',
        'thumb' : '/Thor_Ragnarok.jpg',
        'title' : 'Thor : Ragnarok',
